...
void setup() {
  ...
  LoopTimer=micros();
  angle();
  rollTarget=KalmanAngleRoll;
  pitchTarget=KalmanAnglePitch;
}
void angle()
{
gyro_signals();
...
void loop() {
  angle();
  Roll_Error=rollTarget-KalmanAngleRoll;
  Pitch_Error=pitchTarget-KalmanAnglePitch;
  Serial.print("Roll_Error_[°] ");
  Serial.print(Roll_Error);
  Serial.print(" Pitch_Error_[°] ");
